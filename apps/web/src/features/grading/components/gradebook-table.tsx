        ...
        <Table density="compact">
          <TableHeader>
            <TableRow className="bg-muted/50 hover:bg-muted/50">
              <TableHead className="sticky left-0 z-10 bg-muted/50 backdrop-blur">
                Student
              </TableHead>
              {columns.map((item) => (
                    ...
                    return (
                      <TableCell key={col.itemId} className="text-center">
                        <div className="flex items-center justify-center gap-1.5">
                          {item.solved && <Check className="size-3.5 text-success" />}
                          {item.score === null ? (
                            ...
                            <span
                              className={cn(
                                item.score > 0 ? 'font-medium' : 'text-muted-foreground',
                              )}
                            >
